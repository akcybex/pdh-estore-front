                                    ...
                                    <div>
                                        <div className="media">
                                            <div className="text-center">
                                                <img src={"/assets/images/about/avtar.jpg"} alt="#" />
                                                <h5>Usman Shah</h5>
                                                <h6>Technical Person</h6>
                                            </div>
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                ...
                                <Slider {...Team4} className="team-4">
                                    <div>
                                        <img src={"/assets/images/about/team/1.jpg"} className="img-fluid" alt="" />
                                        <h4>Rana Ajmal</h4>
                                        <h6>Head & Founder At Company</h6>
                                    </div>
                                    <div>
                                        <img src={"/assets/images/about/team/2.jpg"} className="img-fluid" alt="" />
                                        <h4>Muhammad Zeeshan</h4>
                                        <h6>CEO & Front-end Designer</h6>
                                    </div>
                                    <div>
                                        <img src={"/assets/images/about/team/3.jpg"} className="img-fluid" alt="" />
                                        <h4>Ahsan Riaz</h4>
                                        <h6>CEO & Designer</h6>
                                    </div>
                                    <div>
                                        <img src={"/assets/images/about/team/4.jpg"} className="img-fluid" alt="" />
                                        <h4>Abdul Muaaz</h4>
                                        <h6>CEO & Idea Creator</h6>
                                    </div>
                                </Slider>
                            </div>
                        </div>
