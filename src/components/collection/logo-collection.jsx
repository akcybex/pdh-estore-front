...
class LogoCollection extends Component {
    ...
    render() {
        return (
            <div>
                {/*SEO Support*/}
                <Helmet>
                    <title>ProHub | Logo Collection</title>
                    <meta name="description" content="ProHub – ProHub Online eCommerce Store Logo Collection" />
                </Helmet>
                {/*SEO Support End */}
