...
class TShirtCollection extends Component {
    ...
    render (){
        return (
            <div>
                {/*SEO Support*/}
                <Helmet>
                    <title>ProHub | T-Shirt Collection</title>
                    <meta name="description" content="ProHub – ProHub Online eCommerce Store T-Shirt Collection" />
                </Helmet>
                {/*SEO Support End */}
                                            ...
                                            <div className="row">
                                                <div className="col-sm-12">
                                                    <div className="top-banner-wrapper">
                                                        <a href="#"><img src={"/assets/images/mega-menu/1.jpg"} className="img-fluid" alt=""/></a>
