    ...
    render (){
        return (
            <div>
                {/*SEO Support*/}
                <Helmet>
                    <title>ProHub | Flyer Designs Collection</title>
                    <meta name="description" content="ProHub – ProHub Online eCommerce Store Flyer Designs Collection" />
                </Helmet>
                {/*SEO Support End */}
                                            ...
                                            <div className="row">
                                                <div className="col-sm-12">
                                                    <div className="top-banner-wrapper">
                                                        <a href="#"><img src={"/assets/images/mega-menu/4.jpg"} className="img-fluid" alt=""/></a>
