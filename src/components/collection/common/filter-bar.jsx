          ...
          <ul>
            <li>
              <i
                ...
                onClick={() =>
                  this.props.products.length !== 0 && this.gridLayout()
                }
              />
            </li>
            <li>
              <i
                ...
                onClick={() =>
                  this.props.products.length !== 0 && this.listLayout()
                }
              />
            </li>
          </ul>
          ...
          <ul>
            <li>
              <img
                ...
                onClick={() =>
                  this.props.products.length !== 0 && this.LayoutView(6)
                }
              />
            </li>
            <li>
              <img
                ...
                onClick={() =>
                  this.props.products.length !== 0 && this.LayoutView(4)
                }
              />
            </li>
            <li>
              <img
                ...
                onClick={() =>
                  this.props.products.length !== 0 && this.LayoutView(3)
                }
              />
            </li>
            <li>
              <img
                ...
                onClick={() =>
                  this.props.products.length !== 0 && this.LayoutView(2)
                }
              />
            </li>
          </ul>
